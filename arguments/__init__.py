...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        # Grid-based velocity advection options.
        self.use_velocity_advection=False
        self.velocity_num_time_steps=30
        self.velocity_grid_resolution=[75, 150, 75]
        
        # Kernel-based velocity field options.
        self.use_velocity_kernel=False
        self.kernel_num=1000
        self.velocity_kernel_num_time_steps=30
        self.velocity_kernel_grid_resolution=[100, 150, 100]
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.velocity_kernel_lr_init = 0.0016
        self.velocity_kernel_lr_final = 0.00016
        ...
        self.lambda_dssim = 0
        self.lambda_lpips = 0
        self.lambda_spherical = 0.0  # Spherical regularization weight (encourage Gaussians to be spherical)
        ...
        self.visualize_interval=500
        self.save_iter_images=False
        self.save_iter_images_interval=100
        self.visualize_pointcloud_interval=500
        self.use_test_in_training=False
